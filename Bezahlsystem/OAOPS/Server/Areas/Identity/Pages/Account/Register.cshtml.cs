...
namespace OAOPS.Server.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// 
            [Required]
            [StringLength(16, ErrorMessage = "Der {0} muss mindestens {2} und maximal {1} lang sein.", MinimumLength = 3)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (user.UserName == "bamsti")
                    {
                        var res3 = await roleManager.CreateAsync(new IdentityRole("Admin"));
