...
namespace DataAccess.Migrations
{
    ...
    [Migration("20221004130041_Init2")]
    partial class Init2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.BoughtArticle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccess.Models.Payment", b =>
                {
                    b.HasOne("DataAccess.Models.ApplicationUser", "Executor")
                        .WithMany()
                        .HasForeignKey("ExecutorId");

                    b.HasOne("DataAccess.Models.ApplicationUser", "Person")
                        .WithMany("Payments")
